...
- **Configuration:** `kino_core::Config` is the single config type. The loader
  ...
  `KINO_LIBRARY__CANONICAL_TRANSFER`,
  `KINO_LIBRARY__ARTWORK_CACHE_DIR`,
  `KINO_LIBRARY__SUBTITLE_STAGING_DIR`,
  `KINO_SERVER__CORS_ALLOWED_ORIGINS`,
  `KINO_SERVER__DISCOVERY__ENABLED`,
  `KINO_SERVER__DISCOVERY__INSTANCE_NAME`,
  `KINO_SERVER__LISTEN`, `KINO_SERVER__PAIRING_REAPER__TICK_SECONDS`,
  `KINO_SERVER__PAIRING_REAPER__RETENTION_SECONDS`,
  `KINO_SERVER__SESSION_REAPER__TICK_SECONDS`,
  `KINO_SERVER__SESSION_REAPER__ACTIVE_TO_IDLE_SECONDS`,
  `KINO_SERVER__SESSION_REAPER__IDLE_TO_ENDED_SECONDS`,
  `KINO_TMDB__API_KEY`, `KINO_TMDB__MAX_REQUESTS_PER_SECOND`,
  `KINO_OCR__TESSERACT_PATH`, `KINO_OCR__LANGUAGE`,
  `KINO_PROVIDERS__DISC_RIP__PATH`,
  ...
  `KINO_TRANSCODE__POLICY__COMPAT__MAX_HEIGHT`,
  `KINO_TRANSCODE__SCHEDULER__TICK_MILLIS`,
